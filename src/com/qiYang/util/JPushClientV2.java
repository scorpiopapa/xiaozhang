...
public class JPushClientV2 {

	private static final String appKey ="fe3fc1570f89b410750c5d5f";	//必填，例如466f7032ac604e02fb7bda89

	private static final String masterSecret = "5099a385464399add26ed5ca";//"13ac09b17715bd117163d8a1";//必填，每个应用都对应一个masterSecret
...
//		testSend();
	...
	public static MessageResult testSend(String memi,String msgTitle,String msgContent) {
...
//		MessageResult msgResult = jpush.sendCustomMessageWithAppKey(sendNo,msgTitle, msgContent);
		MessageResult msgResult = jpush.sendCustomMessageWithAlias(sendNo, memi, msgTitle, msgContent);
		...
		/*if (null != msgResult) {
		System.out.println("服务器返回数据: " + msgResult.toString()+"对象别名："+memi);
		...
		System.out.println("服务器返回数据: " +"对象别名："+memi);
		System.out.println("无法获取数据"+"-->对象别名："+memi);
	}
		return msgResult;
	}
