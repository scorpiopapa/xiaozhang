...
KE.setting = {
	...
	items : [
		...
		'italic', 'underline', 'strikethrough', 'removeformat', '|', 
		 'advtable', 'accessory','hr', 'emoticons', 'link', 'unlink', '|', 'about'
	],
	colorTable : [
...
KE.plugin.accessory = {
        ...
        insert: function(id, url, title, ext) {
            ...
            switch (ext) {
                case "doc":
                    img = "../../editor/skins/default/word.png";
                    break;
                case "xls":
                    img = "../../editor/skins/default/execl.png";
                    break;
                case "ppt":
                    img = "../../editor/skins/default/ppt.png";
                    break;
                ...
                case "pptx":
                    ...
                    break;
                case "rar":
                    img = "../../editor/skins/default/rar_zip.png";
                    break;
                case "zip":
                    img = "../../editor/skins/default/rar_zip.png";
                    break;
                case "txt":
                    img = "../../editor/skins/default/txt.png";
                    break;
                case "pdf":
                    img = "../../editor/skins/default/pdf.png";
                    break;
                default:
                    img = "../../editor/skins/default/file.png";
            }
