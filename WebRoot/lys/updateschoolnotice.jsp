...
<html>
  ...
  <body>
   <center>
   		<s:form action="selectaction!updateSchoolnotice.action" name="myform" method="post" theme="simple">
   		<table id="subtree1" style="DISPLAY: " width="100%" border="1" cellspacing="0" cellpadding="0">
				<s:hidden  name="tbschoolnotice.schoolNoticeId"></s:hidden>
				<tr class="CTitle">
   			...
   			<tr  bgcolor="#EEEEEE">
   				...
   				<tr>
   				<td>公告标题</td>
   				<td><s:textfield name="tbschoolnotice.schnotTitle" id="schnotTitle"/></td>
   				<td>公告内容</td>
   				<td><s:textarea name="tbschoolnotice.schnotContent" id="schnotContent"/></td>
   			</tr>
   			<tr>
   				<td colspan="4"><s:submit value="修改" style="width:50px;height:25px;background:white;"></s:submit> 
