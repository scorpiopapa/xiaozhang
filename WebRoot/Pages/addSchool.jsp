...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >总校添加页面</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				...
				<legend>添加总校</legend>
					  ...
					  <tr>
					    ...
					    <td width="34%">
					    	<input class="text" name='school.schoolName' style="width:154px" id="schoolName"/>&nbsp;<span class="red">*</span>
					    	<input type="hidden" name="school.isValid" value="1"/>
					    </td>
					    <td nowrap="nowrap" align="right">总校简称:</td>
					    <td><input class="text" name='school.schoolMinName' style="width:154px" id="schoolMinName"/>&nbsp;</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='school.schoolPhone' style="width:154px" id="schoolPhone"/>&nbsp;<span class="red">*</span></td>
					    <td align="right">总校地址:</td>
					    <td><input class="text" name='school.schoolAddress' style="width:154px" id="schoolAddress" />&nbsp;<span class="red">*</span></td>
					  </tr>
					  <tr>
					    <td nowrap="nowrap" align="right">总校公交路线:</td>
					    <td><input class="text" name='school.schoolBusWay' style="width:154px" id="schoolBusWay"/>&nbsp;</td>
					    <td align="right">总校停车位置:</td>
					    <td><input class="text" name='school.schoolStopLocation' style="width:154px"/></td>
					  </tr>
					  <tr>
					    ...
					    <td><input class="text" name='school.linemanName' style="width:154px"/></td>
					  </tr>
					  <tr>
					    <td nowrap="nowrap" align="right">联系电话:</td>
					    <td><input class="text" name='school.linemanPhone' style="width:154px"/></td>
					    <td align="right">Email:</td>
					    <td><input type="text" class="text" name='school.linemanEmail' style="width:154px" id="images"/></td>
					  </tr>
					  <tr>
					    <td nowrap="nowrap" align="right">QQ:</td>
					    <td><input class="text" name='school.linemanQq' style="width:154px"/></td>
					    <td nowrap="nowrap" align="right">校长:</td>
					    <td><input class="text" name='school.rectorName' style="width:154px"/></td>
					  </tr>
					  <tr>
					    <td align="right">校长电话:</td>
					    <td><input type="text" class="text" name='school.rectorPhone' style="width:154px" id="images"/></td>
					  	<td nowrap="nowrap" align="right">校长Email:</td>
					    <td><input class="text" name='school.rectorEmail' style="width:154px"/></td>
					  </tr>
					  <tr>
					    <td align="right">校长QQ:</td>
					    <td><input type="text" class="text" name='school.rectorQq' style="width:154px" id="images"/></td>
					  	<td nowrap="nowrap" align="right">分校数量:</td>
					    <td><input class="text" name='school.subSchoolNum' style="width:154px" id="subSchoolNum"/><span class="red">*</span></td>
					  </tr>
					  <tr>
					    <td align="right">学生人数:</td>
					    <td><input type="text" class="text" name='school.studentNum' style="width:154px" id="studentNum"/><span class="red">*</span></td>
					  	<td align="right">营业执照:</td>
					    <td><input type="text" class="text" name='school.schoolCertificate' style="width:154px"/><span class="red">*</span></td>
					  </tr>
					  <tr>
					    <td nowrap="nowrap" align="right">单位:</td>
					    <td><input class="text" name='school.schoolUnit' style="width:154px"/></td>
					  ...
					  <tr>
					    ...
					    <td clospan="3"><input class="text" name='school.schoolUrl' style="width:154px"/></td>
					  </tr>
					  <!-- <tr>
					    <td align="right">开设课程:</td>
					    <td colspan="3"><textarea name="school.schoolCourse" id="schoolCourse" cols="100" rows="8"></textarea></td>
					  </tr> -->
					  <tr>
					    <td align="right">总校简介:</td>
					    <td colspan="3"><textarea name="school.schoolIntroduce" id="schoolIntroduce" cols="100" rows="8"></textarea></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
