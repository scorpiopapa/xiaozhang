...
<body class="ContentBody">
  <form action="addChargesDo.action" method="post" enctype="multipart/form-data" name="form" onsubmit="return checkForm();">
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >费用信息添加页面</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				...
				<legend>添加费用信息</legend>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='charge.chargeName' style="width:154px" id="chargeName" />&nbsp;<span class="red">*</span></td>
					    <td align="right">金额:</td>
					    <td><input class="text" name='charge.vipCharge' style="width:154px" id="vipCharge" />&nbsp;<span class="red">*</span></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
