...
<body class="ContentBody">
  <form action="addViptimeDo.action" method="post" enctype="multipart/form-data" name="form" onsubmit="return checkForm();">
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >VIP信息添加页面</th>
  </tr>
  <tr>
    <td class="CPanel">
				...
				<legend>添加VIP信息</legend>
					  ...
					  <tr>
					    ...
					    <select name="branch.branchSchoolId" id="branch" onchange="getUser(this.value);">
                          ...
                          <option value="${bs.branchSchoolId }">${bs.braschName }</option>
                          </c:forEach>
                        </select><span class="red">*</span>
                        </c:if>
					  ...
					  <tr>
					    ...
					    <select name="userInfo.userInfoId" id="userInfo">
                          ...
                          <option value="${bs.userInfoId }">${bs.userInfoName }</option>
                          </c:forEach>
                        </select><span class="red">*</span>
                        </c:if>
						</td>
					  ...
					  <tr>
					    ...
					    <td><input class="text Wdate" name='viptime.startTime' style="width:154px" id="startTime" onclick="WdatePicker()"/>&nbsp;<span class="red">*</span></td>
					    <td align="right">到期时间:</td>
					    <td><input class="text Wdate" name='viptime.endTime' style="width:154px" id="endTime" onclick="WdatePicker()"/>&nbsp;<span class="red">*</span></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
