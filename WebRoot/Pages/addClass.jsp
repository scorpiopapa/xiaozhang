...
function getBanInfo(lessonid) {
		if(lessonid=="")
			lessonid=0;
		var url = 'getLessonJsons.action';
		var params = 'lessonid=' + lessonid;
		new Ajax.Request(url, {
			method : 'POST',
			parameters : params,
			onFailure : showError,
...
<body class="ContentBody">
  <form action="addClassDo.action" method="post" enctype="multipart/form-data" name="form" onsubmit="return checkForm();">
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>添加班级</legend>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='course.classNumber' id="classNumber" style="width:154px"/><span class="red">*</span></td>
                        </tr>
                        <tr>
                        <td align="right">班级名称:</td>
					    <td><input class="text" name='course.courseName' id="courseName" style="width:154px"/><span class="red">*</span></td>
                        <td align="right">上课时间:</td>
					    <td><input class="text" name='course.studyTime' id="studyTime" style="width:154px"/><span class="red">*</span></td>
                        </tr>
                        <tr>
                        <td align="right">上课教室:</td>
					    <td><input class="text" name='course.address' id="address" style="width:154px"/><span class="red">*</span></td>
                        <td align="right">&nbsp;</td>
					    <td>&nbsp;</td>
                        </tr>
					  </table>
