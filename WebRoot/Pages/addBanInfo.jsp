...
function checkForm(){
	var sbranchId=document.form.elements;
	var sb = false;
	for ( var i = 0; i < sbranchId.length; i++) {
		if(sbranchId[i].checked==true && sbranchId[i].name=="sbranchId"){
			sb=true;
			break;
		}
	}
...
<body class="ContentBody">
  <form action="addBanInfoDo.action" method="post" enctype="multipart/form-data" name="form" onsubmit="return checkForm();">
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >班信息添加页面</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				...
				<legend>添加班信息</legend>
					  ...
					  <tr>
					    ...
					    <tr>
					    <td align="right" nowrap="nowrap">分校:</td>
					    <td colspan="3">
					    	<c:forEach items="${branchlist}" var="bh" varStatus="vss"> 
										<input type="checkbox" name="sbranchId" value="${bh.branchSchoolId}" />
										${bh.braschName}
										<c:if test="${vss.count%5 eq 0 }"><br /></c:if>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='kecheng.courseName' style="width:154px" id="courseName"/>&nbsp;<span class="red">*</span></td>
					    <td align="right">是否推荐:</td>
					    <td>
					    	<input type="radio" name="kecheng.isGood" value="0" />是
					    	<input type="radio" name="kecheng.isGood" value="1" checked/>否
					  ...
					  <tr height="40">
						...
						<input type="checkbox" name="grades" value="${gl.gradeId }"/>${gl.gradeName }&nbsp;&nbsp;
					  ...
					  <tr>
					    ...
					    <td><input type="text" class="text" name='kecheng.enterNeed' style="width:154px"  id="enterNeed"/><span class="red">*</span></td>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='kecheng.totalStudyTime' id="totalStudyTime" style="width:154px"/><span class="red">*</span></td>
					    <td align="right">学习时间:</td>
					    <td><input type="text" class="text" name='kecheng.studyTime' style="width:154px" id="studyTime" onchange="fileChange(this,'images');"/><span class="red">*</span></td>
					  	</tr>
					  <tr>
					  	<td nowrap="nowrap" align="right">学习费用:</td>
					    <td><input class="text" name='kecheng.studyCosts' style="width:154px" id="studyCosts"/><span class="red">*</span></td>
					  
					    <td nowrap="nowrap" align="right">教材费用:</td>
					    <td><input class="text" name='kecheng.textbookCost' id="textbookCost" style="width:154px"/><span class="red">*</span></td>
					  </tr>
					  <tr>
					  	<td align="right">辅导教材:</td>
					    <td><input type="text" class="text" name='kecheng.courseBook' style="width:154px" id="courseBook"/></td>
					    <td nowrap="nowrap" align="right">学期开始时间:</td>
					    <td><input class="text Wdate" name='kecheng.startTerm' id="startTerm" style="width:154px" onclick="WdatePicker()"/></td>
					  </tr>
					  <tr>
					  	<td nowrap="nowrap" align="right">学期结束时间:</td>
					    <td><input class="text Wdate" name='kecheng.endTerm' id="endTerm" style="width:154px" onclick="WdatePicker()"/></td>
					    <td align="right">咨询电话:</td>
					    <td><input type="text" class="text" name='kecheng.phone' style="width:154px" id="phone"/><span class="red">*</span></td>
					  </tr>
					  <tr>
					  	<td nowrap="nowrap" align="right">学后方向:</td>
					    <td><input class="text" name='kecheng.direction' id="direction" style="width:154px"/></td>
					  ...
					  <tr>
					    ...
					    <td colspan="3"><textarea name="kecheng.courseIntroduce" id="courseIntroduce" cols="100" rows="8"></textarea></td>
					 </tr>
					  <tr>
					    <td nowrap="nowrap" align="right">课程特色:</td>
					    <td colspan="3"><textarea name="kecheng.courseGoodness" id="courseGoodness" cols="100" rows="8"></textarea></td>
					 </tr>
					  <tr>
					    <td nowrap="nowrap" align="right">学习目标:</td>
					    <td colspan="3"><textarea name="kecheng.studyGoal" id="studyGoal" cols="100" rows="8"></textarea></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>
