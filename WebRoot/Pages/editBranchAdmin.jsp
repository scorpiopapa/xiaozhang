...
<body class="ContentBody">
	<form action="editBranchAdminDo.action" method="post"
		...
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">分校管理员修改页面</th>
				</tr>
				<tr>
					<td class="CPanel">
									...
									<fieldset style="height:100%;">
										...
										<tr height="50">
											...
											<tr height="50">
												...
												<td width="60%" align="left">
													<input class="text" name='admin.adminName' style="width:154px" value="${admins.adminName }" readonly/>&nbsp;<span class="red">*</span>
