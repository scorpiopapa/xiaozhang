...
<body class="ContentBody">
	<form action="addBranchAdminDo.action" method="post"
		...
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">分校管理员添加页面</th>
				</tr>
				<tr>
					<td class="CPanel">
										...
										<tr height="40">
											...
											<tr height="50">
												...
												<td width="60%" align="left">
													<input type="hidden" name="shcool.schoolId" value="${school.schoolId }" />
													<input class="text" style="width:154px" id="schoolName" value="${school.schoolName }" readonly />
												</td>
											</tr>	
											<tr>
												<th align="right">分&nbsp;&nbsp;&nbsp;&nbsp;校:</th>
												<td><select name="branch.branchSchoolId" id="braschName">
														<option value="">==请选择==</option>
														<c:forEach items="${banchlist }" var="bl">
															<option value="${bl.branchSchoolId }">${bl.braschName }</option>
														</c:forEach>
