...
<body class="ContentBody">
  <form action="editCityDo.action" method="post" enctype="multipart/form-data" name="form" onsubmit="return checkForm();">
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >城市修改页面</th>
  </tr>
  <tr>
    <td class="CPanel">
				...
				<legend>编辑城市</legend>
					  ...
					  <tr height="40">
					    ...
					    <td width="34%">
					    	...
					    	<input class="text" name='citys.cityName' style="width:154px" id="cityName" value="${citys.cityName }"/>&nbsp;<span class="red">*</span>
					    </td>
					  	<td>&nbsp;</td>
					  	<td>&nbsp;</td>
					  </tr>
					  <tr height="40">
					    ...
					    <td width="44%">
					    	<input class="text" name='citys.spell' style="width:154px" id="spell" value="${citys.spell }"/>&nbsp;<span class="red">*</span>
					    </td>
					  	<td>&nbsp;</td>
					  	<td>&nbsp;</td>
					  </tr>
					  <tr>
						...
						<td>&nbsp;&nbsp;
					    	<input type="radio" name="citys.isValid" 
					    		<c:if test="${citys.isValid eq 1 }"> checked </c:if>
					    	 value="1"/>&nbsp;&nbsp;有效&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    	<input type="radio" name="citys.isValid" 
					    		<c:if test="${citys.isValid eq 0 }"> checked </c:if>
					    	 value="0"/>&nbsp;&nbsp;无效
   						</td>
					   </tr>	
					  </table>
